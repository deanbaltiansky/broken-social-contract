...
```{r,include=FALSE}
#I ran this in a separate script. See ~study-2/extramodels.ipynb. This is the output of that script:
repo_url <- "https://raw.githubusercontent.com/deanbaltiansky/broken-social-contract/main/study-2/results_py/"
lasso_all <- readr::read_csv(paste0(repo_url,"ALL_lasso_all.csv"), show_col_types = FALSE)
lasso_unpen <- readr::read_csv(paste0(repo_url,"ALL_lasso_unpen.csv"), show_col_types = FALSE)
ridge_all <- readr::read_csv(paste0(repo_url,"ALL_ridge_all.csv"), show_col_types = FALSE)
ridge_unpen <- readr::read_csv(paste0(repo_url,"ALL_ridge_unpen.csv"), show_col_types = FALSE)
lmg_all <- readr::read_csv(paste0(repo_url,"ALL_optionA_LMG.csv"), show_col_types = FALSE)
...
\
<a href="./different-contracts-app/index.html" target="_blank" rel="noopener"
     style="background:#0b69ff;color:white;padding:0.55em 0.9em;border-radius:8px;text-decoration:none;">
