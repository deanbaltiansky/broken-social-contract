...
We also estimated penalized regression models (ridge and lasso) that shrink or set to zero predictors in the presence of multicollinearity. Applied to the eight weighted value scores alongside controls, these models identify which values retain predictive strength when penalties discourage overfitting. Ridge coefficients highlight relative magnitudes across values, while lasso selections pinpoint the subset of values most robustly associated with the outcomes.
