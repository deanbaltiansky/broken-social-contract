...
dummy-code voting intentions and binarize party id
...
write.csv(df_bsc %>% filter(is_elg == 1),"~/Google Drive/My Drive/american's dream/for github/broken-social-contract/study-1/data/df_bsc_elg.csv",row.names = F)
```
