...
Here, I report the preregistered analyses. Feel free to explore different linear models here:\
\
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(antiest ~ brokencontract_openai + ideo_con,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(antiest ~ brokencontract_openai + ideo_con + SDO + TIPI_agree,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(antiest ~ brokencontract_openai + ideo_con + SDO + TIPI_agree + man + white + hispanic + income_num + edu_num + age,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(antiest ~ brokencontract_openai + ideo_con + SDO + TIPI_agree + man + white + hispanic + income_num + edu_num + age + county_medianincome + county_gini + county_density,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(change ~ brokencontract_openai + ideo_con,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(change ~ brokencontract_openai + ideo_con + SDO + TIPI_agree,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(change ~ brokencontract_openai + ideo_con + SDO + TIPI_agree + man + white + hispanic + income_num + edu_num + age,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(change ~ brokencontract_openai + ideo_con + SDO + TIPI_agree + man + white + hispanic + income_num + edu_num + age + county_medianincome + county_gini + county_density,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(trust_deminst ~ brokencontract_openai + ideo_con,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(trust_deminst ~ brokencontract_openai + ideo_con + SDO + TIPI_agree,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(trust_deminst ~ brokencontract_openai + ideo_con + SDO + TIPI_agree + man + white + hispanic + income_num + edu_num + age,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(trust_deminst ~ brokencontract_openai + ideo_con + SDO + TIPI_agree + man + white + hispanic + income_num + edu_num + age + county_medianincome + county_gini + county_density,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(trust_natinst ~ brokencontract_openai + ideo_con,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(trust_natinst ~ brokencontract_openai + ideo_con + SDO + TIPI_agree,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(trust_natinst ~ brokencontract_openai + ideo_con + SDO + TIPI_agree + man + white + hispanic + income_num + edu_num + age,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(trust_natinst ~ brokencontract_openai + ideo_con + SDO + TIPI_agree + man + white + hispanic + income_num + edu_num + age + county_medianincome + county_gini + county_density,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(vote_likely ~ brokencontract_openai + ideo_con,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(vote_likely ~ brokencontract_openai + ideo_con + SDO + TIPI_agree,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(vote_likely ~ brokencontract_openai + ideo_con + SDO + TIPI_agree + man + white + hispanic + income_num + edu_num + age,data = df_bsc_elg)
...
```{r,results='asis',echo=TRUE,warning=FALSE,message=FALSE}
m1 <- lm(vote_likely ~ brokencontract_openai + ideo_con + SDO + TIPI_agree + man + white + hispanic + income_num + edu_num + age + county_medianincome + county_gini + county_density,data = df_bsc_elg)
