...
county_data <- readr::read_csv(paste0(repo_url,"exclusions.csv"), show_col_types = FALSE)
```

rename vars

```{r}
df_nov24 <- df_nov24_raw %>% 
  rename(PID = CaseId,
         cond = RND_00,
...
```{r}
write.csv(df_bsc,"~/Google Drive/My Drive/american's dream/November 2024/0166 TESS Baltiansky/data/df_bsc.csv",row.names = F)
```
